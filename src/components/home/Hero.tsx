  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        ...
        <div
          className="absolute top-1/4 right-0 w-[400px] h-[400px] bg-gradient-to-bl from-orange-300/30 to-amber-200/30 rounded-full blur-3xl animate-pulse"
          style={{
            animationDelay: "1s",
          }}
        />
        <div
          className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-gradient-to-tr from-primary/20 to-orange-200/30 rounded-full blur-3xl animate-pulse"
          style={{
            animationDelay: "2s",
          }}
        />
