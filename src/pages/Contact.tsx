      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            {contactMethods.map((method, index) => <motion.a key={method.title} href={method.href} target={method.title === "Facebook" ? "_blank" : undefined} rel={method.title === "Facebook" ? "noopener noreferrer" : undefined} initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
