        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            return <div key={project.id}>
                  <Link to={`/it/project/${project.id}`} className="group block bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-2">
                    {/* Project Icon Cover */}
                    <div className="aspect-square bg-gradient-to-br from-[#F16001]/5 via-orange-50 to-amber-50/50 flex items-center justify-center relative overflow-hidden">
                      <IconComponent className="w-20 h-20 text-[#F16001]/70 group-hover:text-[#F16001] group-hover:scale-110" strokeWidth={1.5} />
                    </div>

                    {/* Project Info */}
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-3">
                        <h3 className="text-xl font-bold text-[#333333] group-hover:text-[#F16001]">
                          {project.name}
                        </h3>
          ...
          <div className="flex justify-end mt-12">
            <a href="/it/archive" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="bg-[#F16001] hover:bg-[#d95601] text-white px-8 py-6 text-base font-semibold rounded-xl shadow-lg hover:shadow-xl">
                View More
