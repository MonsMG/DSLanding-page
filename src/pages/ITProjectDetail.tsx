      ...
      <main className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Link
              to="/it"
              className="inline-flex items-center gap-2 text-[#333333]/70 hover:text-[#F16001] transition-colors mb-8"
            >
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <div className="inline-block px-4 py-1 bg-[#F16001]/10 rounded-full mb-4">
              <span className="text-sm font-semibold text-[#F16001] uppercase tracking-wider">
                IT Project
              </span>
            </div>
